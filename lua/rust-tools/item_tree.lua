...
local function handler(_, result)
  ...
  vim.api.nvim_buf_set_name(latest_buf_id, "rustitemtree")
  vim.api.nvim_set_option_value("ft", "rust", { buf = latest_buf_id })
  vim.api.nvim_buf_set_text(latest_buf_id, 0, 0, 0, 0, parse_lines(result))

  rt.utils.resize(true, "-25")
end

function M.item_tree()
  rt.utils.request(0, "rust-analyzer/viewItemTree", get_params(), handler)
end
